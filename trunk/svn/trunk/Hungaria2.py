...
import Sort
from PluginUtils import (register_report, FilterOption, EnumeratedListOption, PersonOption, BooleanOption, NumberOption, StringOption, DestinationOption, NoteOption, MediaOption)
from ReportBase import (Report, ReportUtils, MenuReportOptions, CATEGORY_WEB, MODE_GUI, MODE_CLI, Bibliography)
import Utils
import ThumbNails
import ImgManip
import Mime
...
import Hungaria2_Localization
import Hungaria2_Images

# f = open(os.path.join(const.HOME_DIR, 'plugins' + '/Hungaria2_Localization.pyt'), 'r')
# eval(f.read())
# f.close()
...
register_report(
                ...
                translated_name = _("Hungária (Website Generator)"),
                status = _("Pre-alpha"),
